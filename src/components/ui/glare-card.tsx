...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    '--shade':
      'radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(255,0,0,0) 12%,rgba(255,0,0,0) 20%,rgba(255,0,0,0) 120% ) var(--bg-x) var(--bg-y)/300% no-repeat',
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[280px] [aspect-ratio:17/21]"
      ref={refElement}
      onPointerMove={(event) => {
